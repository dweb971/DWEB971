...
<div class="span3">
    <div class="sidebar">
        ...
        <ul class="widget widget-menu unstyled">
            <li><a href="dashboard.php?key=exo"><i class="menu-icon icon-bold"></i>Créer un exercice </a></li>
            <li><a href="dashboard.php?key=listexo"><i class="menu-icon icon-book"></i>Liste des exercices</a></li>
        ...
        <ul class="widget widget-menu unstyled">
            ...
            <li><a href="dashboard.php?key=logout"><i class="menu-icon icon-signout"></i>Déconnexion </a></li>
        </ul>
    </div>
    <!--/.sidebar-->
</div>
